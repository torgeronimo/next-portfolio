...
const Contact = () => {
    ...
    const socials: {
        ...
        { name: "LinkedIn", href: "https://linkedin.com", icon: "linkedin", tooltip: "LinkedIn" },
        { name: "GitHub", href: "https://github.com", icon: "github", tooltip: "GitHub" },
        { name: "Dribbble", href: "https://dribbble.com", icon: "dribbble", tooltip: "Dribbble" },
        { name: "Medium", href: "https://medium.com", icon: "medium", tooltip: "Medium" },
        { name: "CodePen", href: "https://codepen.io", icon: "codepen", tooltip: "CodePen" },
    ];
    return (
        <section className="py-8" id="contact">
            
            <div className="flex flex-col items-center gap-4 border-b border-(--border) text-center py-8">
                
                {/* <h2 className="section-title pb-6">Contact</h2> */}
                <div className="flex gap-4 pb-12 w-full items-center justify-center text-center">
                    <span className="w-full h-px rounded-4xl block bg-(--border)"/>
                        <h2 className="section-title">Contact</h2>
                    <span className="w-full h-px block bg-(--border)"/>
                </div>
                <h3 className="contact-headline max-w-lg">Let&apos;s build something <span className="text-(--text-muted)">together.</span></h3>
                <p className="text-body max-w-sm">Open to new opportunities, freelance work, or just a conversation about what you&apos;re building.</p>
                <ButtonDark href="mailto:victorgeronimod@gmail.com" text="Send me an email" icon={SendHorizontal} />
                
                <div className="flex flex-col items-center justify-center">

                    <div className="h-30 w-px bg-(--border)"></div>
                    <p className="label py-4">Socials</p>
                    <div className="flex gap-4">
                    {socials.map((s)=>(
                        <Link className="has-tooltip" key={s.name} href={s.href} target="_blank" rel="noopener noreferrer" title={s.tooltip}>{icons[s.icon]}<span className="tooltip">{s.tooltip}</span></Link>
                    ))}
                    </div>
                </div>
            </div>
